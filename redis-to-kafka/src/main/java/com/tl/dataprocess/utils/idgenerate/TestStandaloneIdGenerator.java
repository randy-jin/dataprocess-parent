...
public class TestStandaloneIdGenerator {
	...
	public static void main(String[] args) {
		...
		System.out.println("Time escaped:" + (System.currentTimeMillis() - startTime));
	}
	
	@Test
	public void test1(){
		IdGenerator idGenerator = DefaultIdGenerator.newInstance();
	...
	public void test2(){
		...
		Set<Object> idSet = Collections.synchronizedSet(new HashSet<>());
...
//			});
	...
	public void  test3(){
		...
		IdGenerator idGenerator2 = DefaultIdGenerator.newInstance();
	...
	public void test4(){
		...
		IdGenerator idGenerator3 = DefaultIdGenerator.newInstance();
		long t1 = System.currentTimeMillis();
		for (int i=0; i<500; i++){
//			es1.submit(() -> {
//				int count = 0;
