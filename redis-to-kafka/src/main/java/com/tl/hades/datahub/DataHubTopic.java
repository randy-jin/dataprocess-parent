...
public class DataHubTopic {
	...
	private final static ILogger logger = LoggerHelper.getLogger(DataHubTopic.class);
...
//			this.shardCount = SG3761SqlMapping.getInstance().getShardCount(businessDataitemId);
