 ...
 */
public class OopCurrentFrontDataProcessor extends RunnableTask {

    private final static Logger logger = Logger.getLogger(OopCurrentFrontDataProcessor.class);
    ...
    protected String doCanFinish(Object object) throws Exception {
        ...
        for (MeterData meterData : meterList) {
            ...
            if (!"F2090700".equals(oopDataItemId) && !"F2090200".equals(oopDataItemId) && !"45000500".equals(oopDataItemId) && !"F2090500".equals(oopDataItemId) && !"FF100200".equals(oopDataItemId)) {//TODO
                if (meterAddr == null) {
            ...
            if (oopDataItemId.startsWith("1")) {
            ...
            } else if ("02030000".equals(oopDataItemId)) {
                dataListFinal.add(mpedIdStr);
                ...
                for (int i = 0; i < dataList.size(); i++) {
                    ...
                    meterAddr = dlist.get(0).toString();
                    if (meterAddr.contains("F")) {
                        continue;
                    }
                    String realAddr = TerminalArchives.getInstance().getRealMeterAddrFromLocalOop(areaCode, termAddr, meterAddr);
                    //拼接终端地址用于后续查找档案
                    ...
                    DataSourceObject dso = new DataSourceObject(businessDataitemId, null, alllList);
                    listDataObj.add(dso);
                }
                continue;
                ...
                for (Object datas : dataList) {
                    ...
                    DataSourceObject dso = new DataSourceObject(businessDataitemId, null, finalList);
                    listDataObj.add(dso);

                }

            } else if ("FF100200".equals(oopDataItemId)) {//错误信息1603003
                if (dataList.size() == 0) {
                    continue;
                }
