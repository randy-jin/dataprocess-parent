...
public class WriteCurvePower {

    /**
     * 本示例中建立一张表,名为sampleTable,只含有一个主键, 主键名为pk.
     */
    private static final String TABLE_NAME = "sampleTable4";
    private static final String PRIMARY_KEY_NAME = "pk";

    public static void main(String[] args) {
        final String endPoint = "http://easotstest.cn-hangzhou.ots.aliyuncs.com";
        final String accessId = "j8E7rBBDCaW9lwfz";
        final String accessKey = "0nehrSudL9AhBPgBfQlCeLw2HCWnkc";
        final String instanceName = "easotstest";
...
//            batchGetRow(client);
    ...
    private static void updateRowWithCondition(SyncClient client, String pkValue) {
        // 构造主键
        PrimaryKeyBuilder primaryKeyBuilder = PrimaryKeyBuilder.createPrimaryKeyBuilder();
        primaryKeyBuilder.addPrimaryKeyColumn(PRIMARY_KEY_NAME, PrimaryKeyValue.fromString("bb"));
        PrimaryKey primaryKey = primaryKeyBuilder.build();
...
//        ColumnCondition columnCondition = new SingleColumnValueCondition("Col0", SingleColumnValueCondition.CompareOperator.EQUAL, ColumnValue.fromLong(100));
//        condition.setColumnCondition(columnCondition);
        rowUpdateChange.setCondition(condition);
        rowUpdateChange.put(new Column("Col", ColumnValue.fromLong(100 + 1)));
