...
public class CurveFrontTransferDataProcessor extends UnsettledMessageProcessor {

    private final static Logger logger = LoggerFactory.getLogger(CurveFrontTransferDataProcessor.class);
