...
import com.ls.athena.framework.sqlconfig.SqlMappingByApollo;
...
public class DataHubTopic {
	...
	public DataHubTopic(String businessDataitemId) throws Exception{
		try{
			this.topicName = SqlMappingByApollo.getInstance().getTopicName(businessDataitemId);
			this.fields = SqlMappingByApollo.getInstance().getFields(businessDataitemId);
			this.lifeCycle = SqlMappingByApollo.getInstance().getLifeCycle(businessDataitemId);
