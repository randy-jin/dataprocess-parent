 ...
 */
public class e_meter_event_no_power implements IConversionUtil {
    @Override
    public List<Object> dataProcess(List<Object> dataList, TerminalArchivesObject terminalArchivesObject, String dataSrc){
        ...
        finallyList.add(ProcessUtil.getDataByObj(dataList.get(2), String.class));
        finallyList.add(terminalArchivesObject.getPowerUnitNumber());
        finallyList.add(ProcessUtil.getDataByObj(dataList.get(4), String.class));
        finallyList.add(ProcessUtil.getDataByObj(dataList.get(5), Date.class));//NO_POWER_SD
