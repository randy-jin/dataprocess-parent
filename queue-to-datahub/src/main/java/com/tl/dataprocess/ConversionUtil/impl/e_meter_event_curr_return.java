 ...
 * @return
 */
public class e_meter_event_curr_return implements IConversionUtil {
    @Override
...
//        }
        ...
        finallyList.add(ProcessUtil.getDataByObj(dataList.get(5), Double.class));//ST_RAP_R
        ...
        finallyList.add(ProcessUtil.getDataByObj(dataList.get(10), Double.class));//ST_GRP_1_R_A
        ...
        finallyList.add(ProcessUtil.getDataByObj(dataList.get(15), Double.class));//ST_GRP_2_R_B
