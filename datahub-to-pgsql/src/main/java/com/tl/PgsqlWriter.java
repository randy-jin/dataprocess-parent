 ...
 */
public class PgsqlWriter extends SingleSubscriptionAsyncExecutor {
    Logger logger = LoggerFactory.getLogger(PgsqlWriter.class);
                    ...
                    while (iter.hasNext()) {
                        ...
                        if (colType.equals("date")) {
                            ...
                            if (null == fieldVal) {
                                ...
                                ps.setTimestamp(++index, new Timestamp(date.getTime() * 1000));
                            }
