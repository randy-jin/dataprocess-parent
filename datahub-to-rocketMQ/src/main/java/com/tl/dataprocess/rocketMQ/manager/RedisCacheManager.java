package com.tl.dataprocess.rocketMQ.manager;
...
public class RedisCacheManager {
    ...
    public byte[] getByte(byte[] key) {
        // 使用了lambda表达式
        return (byte[]) redisTemplate.execute((RedisConnection redisConnection) -> redisConnection.get(key));
//        List<Map<String, byte[]>> list = this.redisTemplate.executePipelined(new RedisCallback<Object>() {
...
//        });
////        byte sum = 0;
//        Map<String, byte[]> map1 = list.get(0);
//        System.out.println(map1);
//        for (String key1 : map1.keySet()) {
//            System.out.println("key= " + key1 + " and value= " + map1.get(key).length);
//        }
//        return map1;
    }
